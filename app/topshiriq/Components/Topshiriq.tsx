  ...
  return (
    <div className="w-[95%] mt-6 mx-auto">
      ...
      <div className="flex flex-col gap-4">
        <div className="w-full flex cursor-pointer px-7 py-6 bg-[#1976D2] text-white rounded-2xl justify-between items-center hover:border hover:border-[#0096c7]">
          <span className="font-bold text-left w-[130px] overflow-hidden text-ellipsis whitespace-nowrap">
            {latinToCyrillic("Shartnoma Raqami")}
          </span>
          <span className="font-bold  w-[250px]">
            {latinToCyrillic("Буюртмачи номи")}
          </span>
           <span
            className={`font-bold w-[280px]  overflow-hidden text-ellipsis whitespace-nowrap`}
          >
